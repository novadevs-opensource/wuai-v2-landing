...
export interface ModelPrivacyProps {
...
export default function ModelPrivacy({
    ...
    return (
        <section id="privacy" className="bg-[#000000] text-white overflow-hidden scroll-mt-16">
            <div className="max-w-7xl mx-auto md:px-12 px-6 py-20 md:py-28">
                    ...
                    <div className="lg:border-r border-b lg:border-b-0 border-white/50">
                        ...
                        <div className="p-6 md:p-8 font-anon text-xs md:text-sm leading-loose min-h-60 flex flex-col justify-center">
                            {terminalLines.map((line, i) => (
                                ...
                                >
                                    <span className={line.type === 'command' ? 'text-white' : 'text-primary-500'}>
                                        {line.text}
                                    </span>
                                </div>
                            ))}
                ...
                <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-5 border bg-primary-500 border-black divide-y md:divide-y-0 md:divide-x divide-black">
                    {badges.map((badge, i) => (
                        <span
                            key={i}
