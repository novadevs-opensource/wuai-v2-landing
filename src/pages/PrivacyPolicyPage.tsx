    ...
    <>
      ...
      <div className="border border-gray-400 border-t-0 border-b-0 bordered-container mx-auto bg-white">
        ...
        <Section title="1. Introduction">
          <p>
            Guayaba LLC, a Series of OtoCo DE LLC ("Guayaba," "we," "us," or "our") operates
            the platform at guayaba.run (the "Service"). This Privacy Policy explains how we
        ...
        <Section title="15. Changes to This Policy">
          <p>
            ...
            the "Last Updated" date. For material changes, we will notify you via email or
