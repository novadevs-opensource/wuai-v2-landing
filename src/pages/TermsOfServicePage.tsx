    ...
    <>
      ...
      <div className="border border-gray-400 border-t-0 border-b-0 bordered-container mx-auto bg-white">
        ...
        <Section title="1. Acceptance of Terms">
          <p>
            By accessing or using the Guayaba platform at guayaba.run (the "Service"), you agree to
            be bound by these Terms of Service ("Terms"). If you do not agree, do not access or use
            the Service.
          </p>
          <p>
            These Terms constitute a legally binding agreement between you ("User," "you," or "your")
            and Guayaba LLC, a Series of OtoCo DE LLC ("Guayaba," "we," "us," or "our").
          </p>
          <p>
        ...
        <Section title="4. Description of Service">
          <p>
            ...
            AI-powered autonomous agents ("Agents"). The Service includes:
          </p>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <Section title="5. Subscription Plans and Billing">
          ...
          <p>
            ...
            ("Free Trial"). At the end of the Free Trial period, your subscription will
        ...
        <Section title="7. AI Agents — User Responsibilities">
          ...
          <p>
            ...
            incomplete, or offensive outputs ("Hallucinations"). Guayaba does not warrant the
        ...
        <Section title="13. Intellectual Property">
          ...
          <p>
            ...
            the Service ("User Content"). By using the Service, you grant Guayaba a limited,
