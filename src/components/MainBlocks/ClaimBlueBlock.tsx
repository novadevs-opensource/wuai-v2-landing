...
export default function ClaimBlueBlock({ title, buttonText, buttonHref }: ClaimBlueBlockProps) {
    return (
        <section className="bg-primary-500 bg-[url('../../assets/images/square-network.png')] bg-repeat bg-contain bg-fixed bg-top py-36 px-6 lg:px-12 font-space uppercase font-bold text-center text-white">
